    ...
    <main>
        <section class="hero">
            ...
            <div class="container-btn-info">
                <a href="../dinamic/register" class="btn-start" ><span>Comenzar</span></a>
        ...
        <section class="container-property">
            ...
            <article class="properties">
                <div>
                    <img class='imf-property' src="../assets/icons/question.svg"  alt="">
                ...
                <div>
                    <img class='imf-property' src="../assets/icons/teacher.svg"  alt="">
                ...
                <div>
                    <img class='imf-property' src="../assets/icons/time.svg"  alt="">
                ...
                <div>
                    <img class='imf-property' src="../assets/icons/stream.svg"  alt="">
                ...
                <div>
                    <img class='imf-property' src="../assets/icons/chat.svg"  alt="">
                ...
                <div>
                    <img class='imf-property' src="../assets/icons/rating.svg"  alt="">
